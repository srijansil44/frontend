                ...
                <tr>
                    ...
                    <td>
                        @if($comment->is_active == 1)
                            {!! Form::open(['method'=>'PATCH', 'action'=>['AuthorPostCommentsController@update',$comment->id]]) !!}
                    ...
                    <td> {!! Form::open(['method'=>'DELETE', 'action'=>['AuthorPostCommentsController@destroy',$comment->id]]) !!}
